...
var iCommentReplySchema = new Schema<ICommentReply>(
  {
    user: Object,
    answer: String,
    // likes: [Object],
...
var commentSchema = new Schema<IComment>(
  {
    user: Object,
    comment: String,
...
interface CourseLike extends Document {
  userId: string;
}
const courseLikeSchema = new Schema<CourseLike>({
  userId: String,
});
