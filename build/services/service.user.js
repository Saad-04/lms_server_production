...
const getUserById = (id, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userJson) {
        new errorHandler_1.default("Please login for access this resources!", 400);
    }
    if (userJson) {
...
const getAllUsersService = (res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield user_models_1.default.find().sort({ createdAt: -1 });
    res.status(200).json({
        success: true,
        users,
    });
...
const updateUserRoleService = (res, id, role) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_models_1.default.findByIdAndUpdate(id, { role }, { new: true });
    res.status(201).json({
        success: true,
        user,
    });
